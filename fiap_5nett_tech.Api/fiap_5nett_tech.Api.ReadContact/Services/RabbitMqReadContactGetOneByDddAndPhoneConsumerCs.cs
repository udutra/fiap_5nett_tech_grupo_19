...
namespace fiap_5nett_tech.Api.ReadContact.Services;

/// <summary>
/// 
/// </summary>
/// <param name="scopeFactory"></param>
public class RabbitMqReadContactGetOneByDddAndPhoneConsumerCs(IServiceScopeFactory scopeFactory) : IHostedService
{
