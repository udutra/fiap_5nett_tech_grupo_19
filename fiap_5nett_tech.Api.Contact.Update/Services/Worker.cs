...
namespace fiap_5nett_tech.Api.Contact.Update.Services;
...
public class Worker : IDisposable
{
    ...
    public Worker(IContactInterface contactService, IServiceScopeFactory serviceScopeFactory)
    {
        ...
        _channel.QueueDeclareAsync(queue: QueueConfiguration.ContactUpdatedQueue, durable: false, exclusive: false,
            autoDelete: false, arguments: null);
        _channel.QueueBindAsync(queue: QueueConfiguration.ContactUpdatedQueue, exchange: ExchangeConfiguration.Name,
            routingKey: RoutingKeyConfiguration.RoutingQueueUpdate, arguments: null);
    ...
    public async Task Start()
    {
        ...
        consumer.ReceivedAsync += async (_, ea) =>
        {
            ...
            try
            {
                var contactResponse = ContactService.Update(contactRequest);
